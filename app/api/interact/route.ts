      ...
      try {
        ...
        switch (action) {
          ...
          case "updateQuantity":
            ...
            transaction = await contract.updateQuantity(
          ...
          case "updateProductState":
            ...
            transaction = await contract.updateProductState(
          ...
          case "getProductDetails":
            ...
            res
              .status(200)
              .json({ productFromChain: productDetails, productFromDB });
            break;
